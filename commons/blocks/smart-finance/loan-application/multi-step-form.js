...
export default async function decorate(block, routes) {
  ...
  function MultiStepForm() {
    ...
    const [saveDraftRequestBody, setSaveDraftRequestBody ] = useState({});
    ...
    const context = { activeRoute, setActiveRoute, formState, updateFormState, bankResponse, setBankResponse, saveDraftRequestBody, setSaveDraftRequestBody, handleSetActiveRoute };
